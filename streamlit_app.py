...
def assign_mql_channel(row):
    ...
    if pd.notna(last_page):
        ...
        if ('utm_medium=ppc' in last_page and 'utm_source=google' in last_page) or ('utm_medium=cpc' in last_page and 'utm_source=google' in last_page):
        ...
        if ('utm_source=MKTP' in last_page and 'utm_campaign=banner' in last_page) or ('utm_source=marketplace' in last_page and 'utm_medium=edit_bar' in last_page) or ('hsCtaTracking' in last_page and any(domain in last_page for domain in ['www.doctoralia', 'www.miodottore', 'www.znanylekarz', 'www.jameda', 'www.doktortakvimi'])):
            return 'Banner [MKTPL]', 'Last Page Seen'
        if ('utm_medium=referral' in last_page and 'utm_source=MKTP' in last_page and 'utm_campaign=footer' in last_page) or ('utm_medium=referral' in last_page and 'utm_source=MKTP' in last_page and 'utm_campaign=top-nav' in last_page):
